...
上表から見て 8 割以上が残るはずである。

**【2026-09-07 追記】完了した。予想どおりで、しかも往復損益まで残った。**
段階 1 の Q5−Q1 は +0.040 → **+0.609**、往復損益は +0.212 → **+1.833**、
往復損益との相関は +0.0045 → **+0.1078**。門に足したときの日次総額は
**+40.63 ± 10.59(t=+3.83)、39 日中 33 日で勝つ**。
...
- ~~新鮮な信号(100 ms 格子)での候補 2 の検定~~ **完了 →
  [`mu_cand2_fresh_report.md`](mu_cand2_fresh_report.md)(候補 2 は採用)**
- ~~条件つきの出し直し~~ **完了 → [`mu_requote_report.md`](mu_requote_report.md)
  (効かない。12 通り中 10 通りで従来が有意に優る)**
