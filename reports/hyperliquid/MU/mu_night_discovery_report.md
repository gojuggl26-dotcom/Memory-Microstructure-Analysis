...
1. **本標本(2026-05〜08)ではアジア現物の分足が無料では取れない。** 1 時間足しか
   無いので、第 3 節の「先行関係が決まらない」は**測定の限界**であって、
   「同時に動いている」ことの証明ではない。
   ★2026-09-12 に実測した保持期間は次のとおりで、**直近 2 か月なら 5 分・15 分足で
   組み直せる**(本標本には届かないが、今後に向けては使える)。

   | 粒度 | Yahoo(現物) | Hyperliquid(perp) |
   |---|---|---|
   | 1 分 | 直近 **30 日**(2026-08-13 以降) | 直近 **約 4 日** |
   | 5 分 | 直近 **60 日**(2026-07-15 以降) | 直近 **約 14〜20 日** |
   | 15 分 | 直近 **60 日** | **45 日以上**(1 時間足と同じく上場来の可能性) |
   | 1 時間 | 730 日 | 上場来 |

   つまり **15 分足なら 2026-07-15 以降の約 42 営業日**で、現物・アジア同業・perp を
   そろえて組める。第 3 節をこの粒度でやり直せば、1 時間では消えたラグが見える可能性がある。
